...
const projects = [
  {
    title: "Project One",
    description: "A web application built with React and Node.js that helps users track their daily habits and goals.",
  ...
  {
    title: "Project Two",
    description: "An e-commerce platform with a custom CMS for managing products, orders, and customer data.",
    image: "/placeholder.svg?height=600&width=800",
  ...
  {
    title: "Project Three",
    description: "A mobile-first dashboard for visualizing and analyzing complex data sets in real-time.",
    image: "/placeholder.svg?height=600&width=800",
  ...
  {
    title: "Project Four",
    description: "A social media platform focused on connecting professionals in the tech industry.",
    image: "/placeholder.svg?height=600&width=800",
